...
public class HelpCommand implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (args.length == 0) {
            ...
            p.sendMessage(CC.translate("&7&m------&r &b&lSpartanHub Help &7&m------"));
            p.sendMessage(CC.translate(""));
            p.sendMessage(CC.translate("&b- &f/spartanhub help &7| &bSends this message"));
            p.sendMessage(CC.translate("&b- &f/spartanhub reload &7| &bReloads the configuration"));
            p.sendMessage(CC.translate("&b- &f/setspawn &7| &bSets the spawn location!"));
            p.sendMessage(CC.translate("&b- &f/spartanhub alias &7| &bSends command aliases!"));
            p.sendMessage(CC.translate(""));
